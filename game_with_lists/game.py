...
В подземелье ты можешь найти 4 предмета:
      Молоток - ты можешь попробовать отбиться им от монстра, но вряд ли уйдешь целым
      Меч - он поможет тебе мгновенно одолеть 1 чудовище
      Хил - если ты его выпьешь, то восстановишь 5 хп
      Чебурек - если ты его съешь, то восстановишь 10 хп 
            ...
            if (player.x, player.y) not in was_in:
                ...
                if do == "Молоток":
                    if player.heart - 5 < 0:
                        ...
                        player.heart = 0
                        break
                    print("Ты попытался отбиться от монстра молотком и что-то даже получилось, но получилось скверно.")
                    print("Молоток сломан")
